...
class RetrieveSpeeches:
    ...
    def retrieve(self) -> None:
        ...
        speeches_cache = utils.load_cached_speeches(self._settings.metadata_json)
        ...
        speeches_live = utils.cache_speeches(self._settings.metadata_json, speeches_live)
        xxx = list(speeches_live)
